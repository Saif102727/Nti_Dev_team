...
def run_task5(student_id):

    # ------------------------------------------------------
    # Task 4: Generate 10 schedules
    # ------------------------------------------------------
    student, schedules = (
        Schedule_Generation.run_task4(
            student_id,
    ...
    # ------------------------------------------------------
    # Get allocations used by Task 4
    # ------------------------------------------------------
    allocations = (
        Schedule_Generation
    ...
    # ------------------------------------------------------
    # Task 5: Rank the schedules
    # ------------------------------------------------------
    best_schedule = optimize_schedules(
        schedules,
        student,
        university_schedule,
        allocations
...
if __name__ == "__main__":
    ...
    best_schedule = run_task5(student_id)

    display_best_schedule(best_schedule)